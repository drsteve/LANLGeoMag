...
Earth.Radius_b  = WGS84_B/Re;
    ...
    *Flag1 = *Flag2 = *Flag3 = FALSE;
    if ( !EllipsoidIntersect( &Earth, &SatToSunRay, &tMin, &tMax, &tMinFwd ) ) {
        ...
        /*
         * Compute vector along trajectory of the sat at time JD (from velocity vector)
         */
...
void IridiumFlare2( _SgpInfo *sgp, double tsince, Lgm_Vector *EarthToSun, int *Flag1, int *Flag2, int *Flag3, Lgm_Vector *g1, Lgm_Vector *g2, Lgm_Vector *g3, Lgm_Vector *P, Lgm_CTrans *c ) {
    ...
    double          RotAngle, Q[4], f, tMin, tMax, tMinFwd, UTC;
    int             Year, Month, Day;
    long int        Date;
    Lgm_Vector      v, zenith, RotAxis, n1, n2, n3;
    Lgm_Vector      sun, vv, r1, r2, r3, Pteme, Vteme;
