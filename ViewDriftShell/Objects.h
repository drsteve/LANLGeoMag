...
int BoxIntersect( BoxType *Box, RayType *Ray, double t0, double t1 );
int SphereIntersect(SphereType *Sphere, RayType *Ray, double *tmin, double *tmax, double *t );
int EllipsoidIntersect(EllipsoidType *Ellipsoid, RayType *Ray, double *tmin, double *tmax, double *t );
