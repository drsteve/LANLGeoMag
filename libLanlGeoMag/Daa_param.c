...
This subroutine calculates the bounce-averaged pitch-angle diffusivity (radians^2/s)
using a parameterization  of the Summers (2005) model for:
...
such that the concentration is fixed at 3500 cm^(-3) at L=2, and decreases more rapidly with
increasing gamma
