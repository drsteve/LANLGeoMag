...
C     WRITE(6,*) 'F1 = ', F1, MAP(I1+3),NL,NB
      IF(S2) F2=TRARA2(MAP(I2+3),NL,NB)/FSCALE
C     WRITE(6,*) 'F2 = ', F2, MAP(I2+3),NL,NB
      S1=.FALSE.                                                        
      S2=.FALSE.                                                        
C
  ...
  1   L2=MAP(I2+1)  
	...
	I1=I2                                                             
    	L1=L2
      	...
      	GOTO 1                                                           
  2   CONTINUE    
CC      WRITE(6, *) 'I1, I2, L1, L2, MAP(I2+2), IL = ', IL, I1, I2, 
C     & L1, L2, 'MAP(I2+2) = ', MAP(I2+2), 'IL = ', IL
C  
...
C
    ...
    5 	KT=I1                                                             
      	...
      	L1=L2                                                             
      	L2=KT                                                             
C      WRITE(6, *) 'KT, I1, I2, L1, L2 = ', KT, I1, I2, L1, L2
C
...
C 
  10  FLL1=MAP(I1+2)
      ...
      FLOG1=MAP(I1+3)                                                   
      FLOG2=MAP(I2+3)                                                   
C      WRITE(6, *) 'FLOG1, FLOG2 = ', FLOG1, FLOG2
      FKB1=0.                                                           
      FKB2=0.                                                           
C      WRITE(6, *) 'L1 = ', L1
      IF(L1.LT.4) GOTO 32
...
C                                               
 	...
 	FINCR2=MAP(I2+J2)                                                 
      	...
      	FKB2=FKB2+FINCR2                                                  
      FLOG2=FLOG2-FISTEP                                                
C     WRITE(6,*)'I2,J2,FKB2,FINCR2,FNB,FLOG2,FISTEP=',
C    &I2,J2,FKB2,FINCR2,FNB,FLOG2,FISTEP
   17 CONTINUE
   ...
   28 FLOGM=FLOG1+(FLOG2-FLOG1)*DFL                                     
      ...
      FLOG2=FLOG2-FISTEP                                                
      SL2=FLOG2/FKB2                                                    
C     WRITE(6,*)'11111111111111111111 SL2 =',SL2
      IF(L1.LT.4) GOTO 35                                               
      J1=4                                                              
      FINCR1=MAP(I1+J1)                                                 
      FKB1=FKB1+FINCR1                                                  
   ...
   29 FKBM=FKBJ1+(FKB2-FKBJ1)*DFL                                       
      ...
      SL1=FLOG1/FKB1                                                    
      SL2=FLOG2/FKB2                                                    
C     WRITE(6,*)'00000000000000000000 SL1,SL2 =',SL1,SL2

   15 CONTINUE
C     WRITE(6,*)'99999999999999999999 SL2 =',SL2
      IF(SL1.LT.SL2) GOTO 20                                            
      	FKBJ2=((FLOG2/FISTEP)*FINCR2+FKB2)/((FINCR2/FISTEP)*SL1+1.)       
      	FKB=FKB1+(FKBJ2-FKB1)*DFL                                         
      	FLOG=FKB*SL1                                                      
C     WRITE(6,*)'2. FKB,FKB1,FKBJ2,FKB1,DFL,FNB,SL1,SL2=',
C    &FKB,FKB1,FKBJ2,FKB1,DFL,FNB,SL1,SL2
   ...
   20 FKBJ1=((FLOG1/FISTEP)*FINCR1+FKB1)/((FINCR1/FISTEP)*SL2+1.)       
      ...
      IF(FKB.GE.FNB) GOTO 60                                            
      	FKBM=FKB                                                          
      	FLOGM=FLOG                                                        
C     WRITE(6,*)'3. FKB,FKB1,FKBJ2,FKB1,DFL,FNB,SL1,SL2=',
C    &FKB,FKB1,FKBJ2,FKB1,DFL,FNB,SL1,SL2
      	IF(J2.GE.L2) GOTO 50                                             
      	J2=J2+1                                                           
      	FINCR2=MAP(I2+J2)                                                 
...
C     WRITE(6,*) 'RESULT,FLOGM, FLOG, FNB, FKBM = ', 
C    &TRARA2,FLOGM,FLOG,FNB,FKBM
      RETURN                                                            
   50 TRARA2=0.                                                         
      RETURN                                                            
      END
